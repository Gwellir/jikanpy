...
def test_get_schedule_url_with_day():
    assert (
        ...
        == "https://api.jikan.moe/v4/schedules/tuesday"
    )
...
def test_get_user_url_with_anime_history():
    assert (
        ...
        == "https://api.jikan.moe/v4/users/xinil/history/anime"
    )
...
def test_get_user_url_with_friends_and_page():
    assert (
        ...
        == "https://api.jikan.moe/v4/users/xinil/friends/2"
    )
...
def test_get_user_url_with_animelist_and_page_parameter():
    assert (
        ...
        == "https://api.jikan.moe/v4/users/xinil/animelist/completed?page=2"
    )
